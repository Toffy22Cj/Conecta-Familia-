...
import com.conectafamilia.backend.repository.ChallengeRepository;
import com.conectafamilia.backend.repository.ForumPostRepository;
    ...
    private void seedScenarios() {
        if (scenarioRepository.count() == 0) {
            Scenario scenario1 = Scenario.builder()
                    ...
                    .description("Tu hijo adolescente llega 2 horas después de la hora acordada y responde con agresividad al ser cuestionado: '¡Déjame en paz, no es para tanto!'")
                    .options(List.of(
                            new Scenario.Option("A", "Responder con enojo: '¡Mientras vivas bajo mi techo sigues mis reglas!'", "Incorrecto. Esto escala el conflicto y rompe la comunicación.", false),
                            new Scenario.Option("B", "Escucha activa: 'Veo que estás molesto. Hablemos mañana cuando estemos más tranquilos sobre por qué llegaste tarde.'", "Correcto. Valida la emoción sin ignorar la regla, postergando la discusión a un momento sin tensión.", true),
                            new Scenario.Option("C", "Indiferencia: Ignorarlo e irse a dormir.", "Incorrecto. El silencio no resuelve el problema ni establece límites claros.", false)
                    ))
                    .build();
    ...
    private void seedChallenges() {
        if (challengeRepository.count() == 0) {
            Challenge challenge1 = Challenge.builder()
                    ...
                    .description("Disfruten de una comida familiar completa sin usar teléfonos móviles, tabletas ni televisión. Aprovechen para preguntarse cómo les fue en el día.")
                    .estimatedMinutes(45)
            ...
            Challenge challenge2 = Challenge.builder()
                    ...
                    .description("Dedica 10 minutos ininterrumpidos a escuchar a tu hijo/a sobre un tema de su interés sin juzgar, interrumpir ni dar consejos no solicitados.")
                    .estimatedMinutes(10)
                    .category("Empatía")
                    .build();
    ...
    private void seedForum() {
        if (forumPostRepository.count() == 0) {
            ForumPost post = ForumPost.builder()
                    ...
                    .content("Hola a todos, mi hijo de 4 años suele hacer rabietas cuando vamos al supermercado y no le compro dulces. ¿Qué estrategias les han funcionado a ustedes para manejar esta situación sin perder la paciencia?")
            ...
            ForumPost.Comment comment1 = ForumPost.Comment.builder()
                    ...
                    .content("¡Hola Carlos! A mí me sirve mucho anticiparle lo que vamos a hacer antes de salir de casa. Le digo claramente qué vamos a comprar y le pido que me ayude a buscar los productos. Así se mantiene ocupado.")
            ...
            ForumPost.Comment comment2 = ForumPost.Comment.builder()
                    ...
                    .content("Excelente consejo, Lucía. Además de la anticipación, validar su emoción es clave. Puedes decirle: 'Sé que quieres el dulce y te enoja no tenerlo, pero hoy solo venimos por las verduras'. Mantén un tono de voz calmado.")
