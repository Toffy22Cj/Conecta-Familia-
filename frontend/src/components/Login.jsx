      ...
      <div className="auth-split-wrapper">
        ...
        <div className="auth-split-card glass-panel">
          <div className="auth-info-panel">
            ...
            <p>
              Únete a cientos de familias que ya
              <br />
              fortalecen sus vínculos día a día.
            </p>
            <div className="auth-badges-container">
              <div className="auth-badge badge-green">
                <ShieldCheck size={16} /> COMUNIDAD SEGURA
              </div>
              <div className="auth-badge badge-white">
                <Heart size={16} /> ACOMPAÑAMIENTO PROFESIONAL
              </div>
            </div>
          </div>
            ...
            <div className="auth-footer-split">
              <p>
                ...
                <a
                  href="#registro"
                  className="auth-link"
                  onClick={(e) => onNavigate("register", e)}
                >
                  Regístrate aquí
                </a>
              </p>
